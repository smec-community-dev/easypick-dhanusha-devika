...
urlpatterns = [
    ...
    path('customer_order_history/<int:order_id>/', views.customer_order_history, name='customer_order_detail'),
    ...
    path('payment/<int:id>/', views.single_payment_view, name='single_payment'),
    path('payment/', views.single_payment_view, name='cart_payment'),
    ...
    path('place_single_order/<int:id>', views.place_single_order, name='place_single_order'),
    ...
    path('customer/verify-otp/', verify_otp, name='customer_verify_otp'),
]
if settings.DEBUG:
